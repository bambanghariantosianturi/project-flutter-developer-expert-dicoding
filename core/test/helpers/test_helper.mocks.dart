...
class MockDatabaseHelper extends _i1.Mock implements _i22.DatabaseHelper {
  ...
  @override
  _i7.Future<int> insertTvSeriesList(_i21.TvSeriesTable? tvSeries) =>
      (super.noSuchMethod(
        Invocation.method(
          #insertTvSeriesList,
          [tvSeries],
  ...
  @override
  _i7.Future<int> removeTvSeriesList(_i21.TvSeriesTable? tvSeries) =>
      (super.noSuchMethod(
        Invocation.method(
          #removeTvSeriesList,
          [tvSeries],
  ...
  @override
  _i7.Future<List<Map<String, dynamic>>> getTvSeriesList() =>
      (super.noSuchMethod(
        Invocation.method(
          #getTvSeriesList,
          [],
